const RADIO_NAME = 'Supernova 92.7 FM';
const URL_STREAMING = 'https://stream.zeno.fm/wrgtjlo80ctvv';
const url = 'https://api.zeno.fm/mounts/metadata/subscribe/wrgtjlo80ctvv';
